...
@section('content')
@section('title', 'Create Other App')
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create Other App</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Other App</li>
            </ol>
        </nav>
    </div>
</div>
...
<section class="content">
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-white">
            <h5 class="m-0 font-weight-bold text-primary">Add New App</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.other-apps.store') }}" data-action="redirect" class="formaction"
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-4">
                        <div class="text-center mb-4">
                            <div class="avtar">
                                <img src="{{ getImage('') }}" class="avtar_img" id="preview_image" />
